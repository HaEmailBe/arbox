...
<body>
    <div id="configPanel" class="config-panel">
        ...
        <button class="btn-initialize" onclick="initializeSystem()">
            Initialize System
        </button>
    </div>
    ...
    <div class="container col-4 mx-auto hidden" id="mainContainer">
        ...
        <div id="mainContent">
            <div class="header col-12">
                ...
                <button class="btn btn-warning ms-3" onclick="returnAllToGround()">
                    Return All to Ground
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        function initializeSystem() {
            ...
            numElevators =
                parseInt(document.querySelector("#numElevators").value) || 5;
        ...
        function renderSystem() {
            ...
            elevators.forEach((elevator, index) => {
                ...
                for (let i = 0; i < numFloors; i++) {
                    ...
                    span.setAttribute("id", `span_s${index}_f${i}`);
                    span.classList.add(
                        "d-flex",
                        "justify-content-center",
                        "align-items-center",
        ...
        function assignElevator(elevatorId, targetFloor) {
            ...
            elevator.direction =
                targetFloor > elevator.currentFloor ? "up" : "down";
        ...
        function moveElevator(elevatorId, targetFloor) {
            ...
            function animate() {
                ...
                elevator.currentFloor =
                    startFloor + (targetFloor - startFloor) * progress;
        ...
        function elevatorArrived(elevatorId, targetFloor) {
            ...
            updateShaftDisplay(elevatorId, targetFloor, floor, true);
            ...
            setTimeout(() => {
                ...
                updateFloorButton(targetFloor);
                updateShaftDisplay(elevatorId, targetFloor, floor, false);
                // Process queue
                if (queue.length > 0) {
        ...
        function updateFloorButton(floorNum) {
            ...
            if (floor.status === "call") {
                ...
                button.textContent =
                    floorNum !== 0 ? `Arrived (${time}s)` : "Arrived";
                button.disabled = true;
            }
        }

        function updateShaftDisplay(elevatorId, targetFloor, floor, show) {
            console.log(elevatorId, targetFloor, floor);
            const span = document.querySelector(
                `#span_s${elevatorId}_f${targetFloor}`
            );
